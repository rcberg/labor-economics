...
Now let's look at how the mininum wage in each state has held up when we adjust them for inflation. Here I am using the Consumer Price Index (compiled by the Bureau of Labor Statistics) relative to the year 2005 as the measure of inflation.
